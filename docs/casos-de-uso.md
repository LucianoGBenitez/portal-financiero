...
| E2  | El sistema no logra detectar automáticamente alguna columna requerida | El sistema solicita al Personal Administrativo Contable mapear manualmente la columna correspondiente antes de continuar |
...
| 5   | —                                                                    | El sistema genera un PDF de control y lo envía automáticamente por WhatsApp a la Jefa de Administración           |
...
| #   | Acción (actor)                                              | Reacción (sistema)                                                                                          |
| --- | ------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------- |
| 1   | El Personal Administrativo Contable carga o selecciona el padrón bancario externo (Interbanking) | El sistema obtiene el maestro de socios de negocio desde SAP y contrasta ambos registros                     |
| 2   | El Personal Administrativo Contable revisa las tres categorías generadas               | El sistema clasifica los resultados en actualizaciones inmediatas, sugerencias por nombre y registros únicos |
| 3   | El Personal Administrativo Contable confirma la actualización masiva                   | El sistema aplica los cambios en el maestro de SAP y registra el resultado de cada actualización              |
...
| Descripción      | El sistema valida el acceso de cualquier usuario contra una lista blanca de cuentas autorizadas y registra en una bitácora centralizada cada operación crítica ejecutada, permitiendo su consulta posterior por el Administrador de Infraestructura / Analista IT. |
| Actores          | Principal: Todos los usuarios del sistema (transversal) / Secundario: Administrador de Infraestructura / Analista IT                                                                          |
...
| 4   | El Administrador de Infraestructura / Analista IT consulta la bitácora                       | El sistema muestra el historial de operaciones registradas                                                    |
